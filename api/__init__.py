"""
상수                  python3 api/constants.py
전체 계좌 조회          python3 api/upbit_accounts.py           https://docs.upbit.com/reference/전체-계좌-조회
캔들                    api/upbit_api.py -> 개선 요망
주문 취소 접수          python3 api/upbit_order_cancel.py       https://docs.upbit.com/reference/주문-취소
주문 가능 정보          python3 api/upbit_order_chance.py       https://docs.upbit.com/reference/주문-가능-정보
