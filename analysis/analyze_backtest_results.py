...
def analyze_coin(coin, daily_average_df, golden_cross_df):
    ...
    combined_df = pd.DataFrame({
        'Backtest': ['Daily Average', 'Golden Cross'],
        'Cumulative Return (%)': [daily_average_coin_df['Cumulative Return (%)'].values[0], golden_cross_coin_df['Cumulative Return (%)'].values[0]],
        'Win Rate (%)': [daily_average_coin_df['Win Rate (%)'].values[0], golden_cross_coin_df['Win Rate (%)'].values[0]],
        'Max Drawdown (MDD) (%)': [daily_average_coin_df['Max Drawdown (MDD) (%)'].values[0], golden_cross_coin_df['Max Drawdown (MDD) (%)'].values[0]]
    })
...
for coin in coins:
    analyze_coin(coin, daily_average_df, golden_cross_df)
